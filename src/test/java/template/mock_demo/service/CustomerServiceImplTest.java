...
public class CustomerServiceImplTest {
    ...
    @Test
    public void testCustomerCreate() throws ParseException {
        // Given
    ...
    @Test
    public void testCustomerGetAll() throws ParseException {
        // given
    ...
    @Test
    public void testCustomerGetById() throws ParseException {
        // given
        String birthDateString = "2001-01-01";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date birthDate = sdf.parse(birthDateString);
    ...
    @Test
    public void testCustomerUpdate() throws ParseException {
        // Given
        // Update
